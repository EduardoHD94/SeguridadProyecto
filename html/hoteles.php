...
session_start(); 
	...
	$db2 = new Database();
	$db2->connect();
	$db2->sql("select NombreHotel, idHotel, Imagen, Precio, Habitaciones, ClasificacionColor.NombreClasificacion, NombreCiudad  from Hotel,Ciudad,ClasificacionColor
			...
			<div class="visiting">
				...
				<div class="container">
					...
					<?php
						...
						echo "<strong>Clasificación: </strong>".$value['NombreClasificacion']."<br></p>";
						echo "<p>
                        <input type='hidden' value='".$value['idHotel']."' name = 'id'><input type='hidden' name='type' value='Hotel' /><input type='hidden' name='product_qty' value='1' /><input type='hidden' name='return_url' value='$current_url' />
